...
#define NORTHSTAR_UNCERTAINTY_X  0.15 // this is the uncertainty of the northstar readings, we are providing
#define NORTHSTAR_UNCERTAINTY_Y  0.17 // you with the capability to independently set the x,y,and theta
#define NORTHSTAR_UNCERTAINTY_TH 0.05

#define WHEELENC_UNCERTAINTY_X  0.08 // this is the uncertainty of the wheel encoder readings, 
#define WHEELENC_UNCERTAINTY_Y  0.08 // 
#define WHEELENC_UNCERTAINTY_TH 0.08

#define PROCESS_UNCERTAINTY_X  0.1 // this is the uncertainty about whether the robot will obey the model
#define PROCESS_UNCERTAINTY_Y  0.1
#define PROCESS_UNCERTAINTY_TH 0.1
