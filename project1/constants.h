...
const float ROOM_ROTATION[4]= {80.7, 0, 95.7, 3.4};
const float ROOM_FLIPX[4] = {0,1,0,0}; //binary flag indicating whether to reflect over x-axis
const float ROOM_FLIPY[4] = {0,0,0,0};
// 
