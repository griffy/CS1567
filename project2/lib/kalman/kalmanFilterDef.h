...
#define WHEELENC_UNCERTAINTY_X  0.05 // this is the uncertainty of the wheel encoder readings, 
#define WHEELENC_UNCERTAINTY_Y  0.05 // 
#define WHEELENC_UNCERTAINTY_TH 0.05
